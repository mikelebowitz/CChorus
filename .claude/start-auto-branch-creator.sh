...
echo -e "${BLUE}📋 Monitoring: BACKLOG.md for [new-branch] metadata${NC}"
echo -e "${BLUE}🌿 Auto-creates: Git branches when metadata detected${NC}"
echo ""
echo -e "${YELLOW}📋 The auto-branch creator will:${NC}"
echo "  1. Scan BACKLOG.md for [new-branch: branch-name] metadata"
echo "  2. Automatically create Git branches for new triggers"
